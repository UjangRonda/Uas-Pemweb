...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2024 at 08:33 AM
...
(1, 'Mobil Mewah', 'HEI FRIENDS HUEHEUHEUE', 15000, 'img-1.png'),
(2, 'Kereta Api', 'tut tut tut', 320000, 'img-2.png'),
(3, 'Mobil ', 'Mclaren lu warna apa bos?', 320000, 'img-3.png');
...
ALTER TABLE `transactions`
  ...
  ADD CONSTRAINT `transactions_ibfk_3` FOREIGN KEY (`shipping_address`) REFERENCES `users` (`address`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
